...
class RecomandedProductsTile extends StatelessWidget {
  const RecomandedProductsTile({super.key});
          ...
          itemBuilder: (context, index) {
            return Row(
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const RatingIndicator(ratings: 2, size: 12),
                        ),
                        Container(
                          padding: const EdgeInsets.only(left: 5),
                          alignment: Alignment.centerLeft,
                ...
                index != ImageHelper.productName.length - 1
                    ? Container(
                        width: 10,
                      )
                    : const SizedBox()
